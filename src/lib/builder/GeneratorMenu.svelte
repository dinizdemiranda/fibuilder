<script>
	...
	import { GENERATOR_TYPES } from './workflow.js';

	let { x, y, onselect, onclose } = $props();
...
<div class="wf-tmenu" style="left: {x}px; top: {y}px;">
	<div class="wf-tmenu-title">Add generated value</div>
	{#each GENERATOR_TYPES as opt (opt.value)}
